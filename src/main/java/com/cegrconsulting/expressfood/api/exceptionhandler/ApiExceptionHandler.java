...
@ControllerAdvice
public class ApiExceptionHandler extends ResponseEntityExceptionHandler { // Esta classe abstrata já trata por padrão
																			// diversas exceções

	public static final String MENSAGEM_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema."
	...
	public ResponseEntity<?> handleUncaught(Exception ex, WebRequest request) {
		...
		String detail = MENSAGEM_ERRO_GENERICA_USUARIO_FINAL;

		ex.printStackTrace(); // importante para termos a stacktrace completa do erro e descobrirmos a causa
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(MENSAGEM_ERRO_GENERICA_USUARIO_FINAL).build();
		return handleExceptionInternal(ex, problem, new HttpHeaders(), status, request);
	}
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			body = Problem.builder()
					...
					.status(status.value())
					.timestamp(LocalDateTime.now()).userMessage(MENSAGEM_ERRO_GENERICA_USUARIO_FINAL)
					.build();
			...
			body = Problem.builder()
					...
					.userMessage(MENSAGEM_ERRO_GENERICA_USUARIO_FINAL)
					.build();
		}
